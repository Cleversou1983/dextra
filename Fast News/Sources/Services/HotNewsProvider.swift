...
class HotNewsProvider {
    ...
    private let kLimitKey   : String    = "limit"
    private let kLimitValue : Int       = 5
    private let kAfterKey   : String    = "after"
    private var kAfterValue : String    = ""
    ...
    //MARK: - Public Methods
    var hasNexPage: Bool {
        return !self.kAfterValue.isEmpty
    }
    
    var getLimit: Int {
        return self.kLimitValue
    }
